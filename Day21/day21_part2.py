...
def main():
    ...
    # Build a list of dangerous ingredients, sorted alphabetically by allergen.
    confirmed_dangerous = sorted([ f"{a}:{b}" for a, b in confirmed_allergens.items() ])
    dangerous_list = [ a.split(':')[1] for a in confirmed_dangerous ]

    # The final result is the list joined separated by commas.
